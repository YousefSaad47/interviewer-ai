        ...
        <div className="w-full max-w-[480px] rounded-[20px] border border-border bg-white/75 p-5 shadow-[3.5px_1.7px_8.5px_4.3px_rgba(0,0,0,0.3)] backdrop-blur-md sm:p-7 md:p-9 dark:border-border dark:bg-card">
          <div className="flex flex-col items-center gap-4 sm:gap-5 md:gap-6">
            ...
            <div className="flex w-full items-center justify-between">
              ...
              <Link
                href="/"
                className="flex items-center gap-[-2.2px] text-foreground transition-opacity hover:opacity-80"
              >
                <ArrowLeft
                  className="h-4 w-4 sm:h-5 sm:w-5"
                  strokeWidth={1.5}
                />
                <span className="font-bold text-[8px] leading-none sm:text-[10px]">
                  Back as Guest
                </span>
              </Link>
              ...
              <Link href="/" className="flex items-center gap-[3.3px]">
                ...
                <span className="font-bold text-[12px] text-foreground leading-none sm:text-[15px]">
                  Interviewer.Ai
                </span>
              </Link>
            </div>
