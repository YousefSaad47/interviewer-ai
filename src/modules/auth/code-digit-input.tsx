...
export function CodeDigitInput({
  ...
  return (
    <div className="w-full">
          ...
          >
            <div className="flex h-full w-full items-center justify-center">
              <input
                ...
                aria-invalid={!!error}
                className={cn(
                  "h-7 w-12 bg-transparent text-center text-xl font-semibold outline-none sm:h-8 sm:w-14 sm:text-2xl",
      ...
      {/* Error Message */}
      {error && (
        <p className="text-destructive mt-1.5 text-center text-xs font-medium sm:text-sm">
          {error}
        </p>
      )}
    </div>
