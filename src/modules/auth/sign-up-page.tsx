    ...
    <AuthLayout>
      ...
      <div className="flex w-full max-w-105 flex-col items-center gap-6 sm:gap-8.5">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          <span className="text-foreground text-[11px] leading-none font-light tracking-[-2.5%] sm:text-[13px]">
            Already Have and Account?
          </span>
          <Link
            href="/auth/signin"
            className="text-primary hover:text-primary/80 text-[11px] leading-none font-light tracking-[-2.5%] transition-all hover:underline sm:text-[13px]"
          >
            Sign in
          </Link>
        </div>
