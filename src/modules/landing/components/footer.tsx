...
export function Footer() {
  const serviceLinks = [
    { label: "Quick Interview", href: "/quick-interview" },
    { label: "Random Problem", href: "/random-problem" },
  ...
  return (
    <footer className="border-border bg-background/95 relative border-t backdrop-blur">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-12 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Service Links */}
          <div>
            <h3 className="text-foreground mb-4 font-bold">Service</h3>
          ...
          {/* Company Links */}
          <div>
            <h3 className="text-foreground mb-4 font-bold">Company</h3>
            <ul className="space-y-3">
          ...
          {/* Resource Links */}
          <div>
            <h3 className="text-foreground mb-4 font-bold">Resource</h3>
            <ul className="space-y-3">
