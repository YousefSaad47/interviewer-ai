          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="relative">
                {/* Number Badge */}
                <div className="from-primary to-primary/80 text-primary-foreground shadow-primary/20 absolute -top-4 -left-4 z-10 flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-br text-lg font-bold shadow-lg">
                  {step.number}
                </div>
